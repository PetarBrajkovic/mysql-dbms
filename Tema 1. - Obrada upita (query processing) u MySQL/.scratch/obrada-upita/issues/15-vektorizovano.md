...
**Scope**: Slide bullet: vectorized execution in modern systems. Comparative and deliberately honest: what vectorized execution is, why row-at-a-time MySQL does not do it, what that costs, and where HeatWave changes the picture.
